...
class ilApiWebex implements ilApiInterface
{
    ...
    //     * @throws ilDatabaseException
    //     */
    //    static public function getInstanceByRefId(int $id) : ilApiWebex
    //    {
     ...
     * @return bool|string
     */
    public function restfulApiCall(?string $endpoint = null, string $method = 'GET', array $param = [], string $contentType = 'application/json;charset=UTF-8')
    {
