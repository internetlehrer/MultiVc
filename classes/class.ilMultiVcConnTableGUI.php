...
class ilMultiVcConnTableGUI extends ilTable2GUI
{
     ...
     */
    public function init(object $a_parent_obj)
    {
        ...
        $this->setRowTemplate('tpl.types_row.html', 'public/Customizing/global/plugins/Services/Repository/RepositoryObject/MultiVc');
