...
class ilMultiVcTableGUIScheduledMeetings extends ilTable2GUI
{
     ...
     * @throws Exception
     */
    public function __construct(ilObjMultiVcGUI|ilMultiVcConfigGUI $a_parent_obj, $a_parent_cmd = '', string $a_template_context = '')
    {
        global $DIC;
        ...
        $this->setRowTemplate('tpl.scheduled_meeting_row.html', 'public/Customizing/global/plugins/Services/Repository/RepositoryObject/MultiVc');
        ...
        if($getWebexMeetingsList && //$a_parent_cmd == 'applyFilterScheduledMeetings') {
            ...
            if($this->parent_obj->isWebex) {
                $this->dic->ui()->mainTemplate()->setOnScreenMessage(
                    'success',
                    $this->dic->language()->txt('rep_robj_xmvc_webex_meetings_list_downloaded'),
                    true
                );
